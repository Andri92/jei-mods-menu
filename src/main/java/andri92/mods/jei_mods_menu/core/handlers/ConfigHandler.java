package andri92.mods.jei_mods_menu.core.handlers;
...
//
//        JEIModsMenu.btnGameMode.setVisible(enableGamemode);
//        JEIModsMenu.btnDay.setVisible(enableTime);
//        JEIModsMenu.btnNight.setVisible(enableTime);
//        JEIModsMenu.btnTrash.setVisible(enableDelete);
//        JEIModsMenu.btnNoMobs.setVisible(enableKillMobs);
//        JEIModsMenu.btnFreeze.setVisible(enableTimeFreeze);
//        JEIModsMenu.btnRain.setVisible(enableWeather);
//        JEIModsMenu.btnSun.setVisible(enableWeather);
//        JEIModsMenu.btnMagnet.setVisible(enableMagnet);
//
//        for (int i = 0; i < JEIModsMenu.btnCustom.length; i++)
//            JEIModsMenu.btnCustom[i].setVisible(enableCustom[i]);
    ...
    public void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent eventArgs) {
        if (eventArgs.getModID().equals(JEIModsMenu.ID)) {
            config.save();
            load();
            JEIModsMenu.configHasChanged = true;
        }
    }
}
